...
// WithdrawalRepository определяет методы для работы со списаниями
...
// NewWithdrawalRepository создает новый репозиторий для списаний
...
// GetByUserID возвращает все списания пользователя, отсортированные по времени (новые первые)
